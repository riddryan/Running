...
%             
    ...
    methods
        ...
        function [this] = SoftParRunner(input)
            %%
            this = this@Runner();
        ...
        function plot(this, state, varargin)
            ...
            statestruc = SoftParRunnerState(state);
        ...
        function [xnew] = switchLegs(this,x,landangle)
            ...
            newstatestruc = SoftParRunnerState(x);
        ...
        function [speed] = getSpeed(this, x0, xf, tf)
            ...
            x0struc = SoftParRunnerState(x0);
            xfstruc = SoftParRunnerState(xf);
...
%             newstate = [x0(1:5) unew'];
        ...
        function [c,ceq] = TakeoffConstraints(this,x0,xf,tf,allx,allt,tair)
            ...
            statesair = SoftParRunnerState(xair);
