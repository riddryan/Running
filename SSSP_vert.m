...
%             legdir = (points.softseries' - points.foot')/norm(points.softseries - points.foot);
            vertdir = [0;1];
            RotNeg90 = [0 1;-1 0];
            perpdir = RotNeg90*vertdir;
            
            legoffset = springstart*vertdir';
            ...
            %Draw Foot
            plotter.plotFoot(points.foot, -pi/2);
            axis equal;
        ...
        function [xnew] = switchLegs(this,x,landangle)
            ...
            newstatestruc = SSSP_vertState(x);
        ...
        function [speed] = getSpeed(this, x0, xf, tf)
            ...
            x0struc = SSSP_vertState(x0);
            xfstruc = SSSP_vertState(xf);
...
% Mass Matrix
MM(1,1) = -2*q2*q6*s1*mfoot + (mfoot + msoftseries)*(q2*q2) + mfoot*(q6*q6); ...
MM(1,2) = c1*q6*mfoot; MM(1,3) = 0; MM(1,4) = q6*mfoot - q2*s1*(mfoot + ...
msoftseries); MM(1,5) = c1*q2*(mfoot + msoftseries); MM(1,6) = ...
-(c1*q2*mfoot); MM(1,7) = 0; 
...
mpelvis + msoftseries + msoftstomach; MM(4,5) = 0; MM(4,6) = 0; MM(4,7) = 0; 
MM(5,1) = MM(1,5); MM(5,2) = MM(2,5); MM(5,3) = MM(3,5); MM(5,4) = MM(4,5); ...
MM(5,5) = mfoot + mpelvis + msoftseries + msoftstomach; MM(5,6) = -mfoot; ...
MM(5,7) = 0; 
MM(6,1) = MM(1,6); MM(6,2) = MM(2,6); MM(6,3) = MM(3,6); MM(6,4) = MM(4,6); ...
MM(6,5) = MM(5,6); MM(6,6) = mfoot; MM(6,7) = 0; 
MM(7,1) = MM(1,7); MM(7,2) = MM(2,7); MM(7,3) = MM(3,7); MM(7,4) = MM(4,7); ...
MM(7,5) = MM(5,7); MM(7,6) = MM(6,7); MM(7,7) = msoftparallel; 

% righthand side terms
rhs(1) = -(q2*(-(c1*u7*csoftparallel) - c1*q7*ksoftparallel + ...
c1*ksoftparallel*lsoftparallel + 2*u1*(-(s1*u6*mfoot) + u2*(mfoot + ...
msoftseries)) + g*mfoot*cos(q1 - gslope) + g*msoftseries*cos(q1 - gslope))) + ...
q6*mfoot*(2*u1*(s1*u2 - u6) + g*sin(gslope)); 
rhs(2) = -(u2*cleg) + s1*u7*csoftparallel + q7*s1*ksoftparallel + kleg*lleg - ...
s1*ksoftparallel*lsoftparallel - 2*c1*u1*u6*mfoot - q6*s1*mfoot*(u1*u1) + ...
q2*(-kleg + (mfoot + msoftseries)*(u1*u1)) - g*mfoot*sin(q1 - gslope) - ...
g*msoftseries*sin(q1 - gslope); 
rhs(3) = -(u3*csoftstomach) - q3*ksoftstomach + ksoftstomach*lsoftstomach - ...
g*msoftstomach*cos(gslope); 
rhs(4) = 2*u1*(-(u6*mfoot) + s1*u2*(mfoot + msoftseries)) + c1*q2*(mfoot + ...
msoftseries)*(u1*u1) + g*(mfoot + mpelvis + msoftseries + ...
msoftstomach)*sin(gslope); 
rhs(5) = u7*csoftparallel + q7*ksoftparallel - ksoftparallel*lsoftparallel - ...
2*c1*u1*u2*mfoot - 2*c1*u1*u2*msoftseries - g*mfoot*cos(gslope) - ...
g*mpelvis*cos(gslope) - g*msoftseries*cos(gslope) - ...
g*msoftstomach*cos(gslope) - q6*mfoot*(u1*u1) + q2*s1*(mfoot + ...
msoftseries)*(u1*u1); 
rhs(6) = -(u7*csoftparallel) - u6*csoftseries - q7*ksoftparallel + ...
ksoftparallel*lsoftparallel + ksoftseries*lsoftseries + 2*c1*u1*u2*mfoot + ...
g*mfoot*cos(gslope) - q2*s1*mfoot*(u1*u1) + q6*(-ksoftseries + ...
mfoot*(u1*u1)); 


rhs(7) = -(u7*csoftparallel) + ksoftparallel*(-q7 + lsoftparallel) - ...
2*c1*u1*u2*msoftparallel - g*msoftparallel*cos(gslope) + (-q6 + q7 + ...
q2*s1)*msoftparallel*(u1*u1); 
% rhs(7) = -(u7*csoftparallel) + ksoftparallel*(-q7 + lsoftparallel) - g*msoftparallel*cos(gslope);
        end
        ...
        function [C, CDot] = getConstraints(this,state,phase)
            ...
            switch phase
                case 'stance'
constraintJacobianStance(1,1) = q6 - q2*s1; constraintJacobianStance(1,2) = ...
c1; constraintJacobianStance(1,3) = 0; constraintJacobianStance(1,4) = 1; ...
constraintJacobianStance(1,5) = 0; constraintJacobianStance(1,6) = 0; ...
constraintJacobianStance(1,7) = 0; 
...
constraintJacobianStance(2,5) = 1; constraintJacobianStance(2,6) = -1; ...
constraintJacobianStance(2,7) = 0; 


constraintJacobianStanceDot(1,1) = -(c1*q2*u1) - s1*u2 + u6; ...
...
0; constraintJacobianStanceDot(1,6) = 0; constraintJacobianStanceDot(1,7) = ...
0; 
...
0; constraintJacobianStanceDot(2,6) = 0; constraintJacobianStanceDot(2,7) = ...
0;
...
velJacobian(4,7) = 0; 
velJacobian(5,1) = q6 - q2*s1; velJacobian(5,2) = c1; velJacobian(5,3) = 0; ...
velJacobian(5,4) = 1; velJacobian(5,5) = 0; velJacobian(5,6) = 0; ...
velJacobian(5,7) = 0; 
velJacobian(6,1) = c1*q2; velJacobian(6,2) = s1; velJacobian(6,3) = 0; ...
velJacobian(6,4) = 0; velJacobian(6,5) = 1; velJacobian(6,6) = -1; ...
velJacobian(6,7) = 0; 
...
velJacobian(9,4) = 0; velJacobian(9,5) = 0; velJacobian(9,6) = 0; ...
velJacobian(9,7) = 0; 
velJacobian(10,1) = 0; velJacobian(10,2) = 0; velJacobian(10,3) = 0; ...
velJacobian(10,4) = 0; velJacobian(10,5) = 0; velJacobian(10,6) = 0; ...
velJacobian(10,7) = 1; 
 ...
 kineticEnergy = (2*c1*u2*u4*mfoot + 2*q6*u1*(c1*u2 + u4)*mfoot + ...
2*s1*u2*u5*mfoot - 2*s1*u2*u6*mfoot - 2*u5*u6*mfoot + 2*c1*u2*u4*msoftseries ...
+ 2*s1*u2*u5*msoftseries - 2*q2*u1*(q6*s1*u1*mfoot + s1*u4*(mfoot + ...
msoftseries) - c1*(-(u6*mfoot) + u5*(mfoot + msoftseries))) + ...
2*u3*u5*msoftstomach + (mfoot + msoftseries)*(q2*q2)*(u1*u1) + ...
mfoot*(q6*q6)*(u1*u1) + mfoot*(u2*u2) + msoftseries*(u2*u2) + ...
msoftstomach*(u3*u3) + mfoot*(u4*u4) + mpelvis*(u4*u4) + msoftseries*(u4*u4) ...
+ msoftstomach*(u4*u4) + mfoot*(u5*u5) + mpelvis*(u5*u5) + ...
msoftseries*(u5*u5) + msoftstomach*(u5*u5) + mfoot*(u6*u6) + ...
...
2*q6*g*mfoot*cos(gslope) + 2*q5*g*mpelvis*cos(gslope) + ...
2*q5*g*msoftparallel*cos(gslope) - 2*q6*g*msoftparallel*cos(gslope) + ...
2*q7*g*msoftparallel*cos(gslope) + 2*q5*g*msoftseries*cos(gslope) + ...
2*q5*g*msoftstomach*cos(gslope) + q3*(-2*ksoftstomach*lsoftstomach + ...
2*g*msoftstomach*cos(gslope)) + kleg*(q2*q2) + ksoftstomach*(q3*q3) + ...
ksoftseries*(q6*q6) + ksoftparallel*(q7*q7) + kleg*(lleg*lleg) + ...
ksoftparallel*(lsoftparallel*lsoftparallel) + ...
ksoftseries*(lsoftseries*lsoftseries) + ...
ksoftstomach*(lsoftstomach*lsoftstomach) - 2*q2*(kleg*lleg - g*(mfoot + ...
msoftparallel + msoftseries)*sin(q1 - gslope)) - 2*q4*g*mfoot*sin(gslope) - ...
2*q4*g*mpelvis*sin(gslope) - 2*q4*g*msoftparallel*sin(gslope) - ...
...
gslope) + q4*g*sin(gslope)) - mfoot*(-((q5 - q6)*g*cos(gslope)) - ...
q2*g*power(c1*c1 + s1*s1,-0.5)*sin(q1 - gslope) + q4*g*sin(gslope)) - ...
msoftparallel*(-((q5 - q6 + q7)*g*cos(gslope)) - q2*g*power(c1*c1 + ...
...
points.COMpos(1) = c1*(q2*mfoot + q2*msoftparallel + ...
...
msoftstomach,-1); 
points.COMpos(2) = s1*(q2*mfoot + q2*msoftparallel + ...
q2*msoftseries)*power(mfoot + mpelvis + msoftparallel + msoftseries + ...
msoftstomach,-1) + ((q5 - q6)*mfoot + q5*mpelvis + (q5 - q6 + ...
q7)*msoftparallel + q5*msoftseries + (q3 + q5)*msoftstomach)*power(mfoot + ...
mpelvis + msoftparallel + msoftseries + msoftstomach,-1); 
...
points.softparallel(1) = c1*q2 + q4; 
points.softparallel(2) = q5 - q6 + q7 + q2*s1; 
        ...
        function [newstate] = GoodInitialConditions(this,x0)
            ...
            stanceang = q1+pi;
            pelvx = (q2)*cos(stanceang);
            pelvy = q6 + (q2)*sin(stanceang);
...
%             Jc*u;
        ...
        function [c,ceq] = additionalConstraints(this,x0)
            %
            [~,~,allx,allt,tair] = this.onestep(x0);
            
            xair = allx(find(allt==tair,1),:);
            statesair = SSSP_vertState(xair);
...
comvx = (q6*u1*mfoot + c1*u2*mfoot + u4*mfoot + u4*mpelvis + ...
c1*u2*msoftseries + u4*msoftseries - q2*s1*u1*(mfoot + msoftseries) + ...
u4*msoftstomach)*power(mfoot + mpelvis + msoftparallel + msoftseries + ...
msoftstomach,-1);

comvy = (u5*mfoot - u6*mfoot + u5*mpelvis + u7*msoftparallel + u5*msoftseries ...
+ c1*q2*u1*(mfoot + msoftseries) + s1*u2*(mfoot + msoftseries) + ...
u3*msoftstomach + u5*msoftstomach)*power(mfoot + mpelvis + msoftparallel + ...
msoftseries + msoftstomach,-1);
        ...
        function softPower = getSoftPower(this,x)
            stomachPower = this.getStomachPower(this,x);
            seriesPower = this.getSeriesPower(this,x);
            parallelPower = this.getParallelPower(this,x);
