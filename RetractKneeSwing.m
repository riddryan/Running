...
potentialEnergy = (2*q2*g*cos(gslope) + kknee*((-q3 + q4 + kneel)*(-q3 + q4 + ...
kneel)) + khip*((q3 + hipl - stanceangle)*(q3 + hipl - stanceangle)) + ...
2*g*lthigh*sin(q3 - gslope) - 2*q1*g*sin(gslope) - ...
2*g*mfoot*(-(q2*cos(gslope)) - lthigh*sin(q3 - gslope) - lshank*sin(q4 - ...
gslope) + q1*sin(gslope)))/2.;
