...
s3m4*kknee*lshank*lthigh + khip*stanceangle - 2*g*lthigh*mfoot*cos(q3 - ...
gslope) - s3m4*lshank*lthigh*mfoot*(u4*u4) + ...
...
hipl - stanceangle)) + kknee*((kneel - power(power(-(c5*lpulley) + c4*lshank ...
+ c3*lthigh,2) + power(-(s5*lpulley) + s4*lshank + s3*lthigh,2),0.5))*(kneel ...
...
accs(1,1) = -(power(lshank,-1)*power(lthigh,-2)*power(-1 - mfoot + ...
mfoot*(c3m4*c3m4),-1)*(-(lshank*(q3*khip + hipl*khip + ...
s3m5*kknee*lpulley*lthigh - s3m4*kknee*lshank*lthigh + 2*c3*g*lthigh*mfoot - ...
khip*stanceangle - s3*lthigh*(1 + mfoot)*xpacc + c3*lthigh*(1 + mfoot)*ypacc ...
...
s3m4*kknee*kneel*lshank*lthigh*power(-2*c4m5*lpulley*lshank - ...
2*c3m5*lpulley*lthigh + 2*c3m4*lshank*lthigh + lpulley*lpulley + ...
lshank*lshank + lthigh*lthigh,-0.5))) + c3m4*lshank*lthigh*(c4*g*mfoot - ...
s4*mfoot*xpacc + c4*mfoot*ypacc - s3m4*lthigh*mfoot*(u3*u3) + ...
kknee*(s4m5*lpulley + s3m4*lthigh)*power(-2*c4m5*lpulley*lshank - ...
2*c3m5*lpulley*lthigh + 2*c3m4*lshank*lthigh + lpulley*lpulley + ...
lshank*lshank + lthigh*lthigh,-0.5)*(-kneel + power(-2*c4m5*lpulley*lshank - ...
2*c3m5*lpulley*lthigh + 2*c3m4*lshank*lthigh + lpulley*lpulley + ...
lshank*lshank + lthigh*lthigh,0.5))))); accs(1,2) = ...
power(lshank,-1)*power(lthigh,-1)*power(mfoot,-1)*(-(q3*khip) - hipl*khip - ...
s3m5*kknee*lpulley*lthigh + s3m4*kknee*lshank*lthigh - 2*c3*g*lthigh*mfoot + ...
khip*stanceangle + s3*lthigh*(1 + mfoot)*xpacc - c3*lthigh*(1 + mfoot)*ypacc ...
- s3m4*lshank*lthigh*mfoot*(u4*u4) + ...
s3m5*kknee*kneel*lpulley*lthigh*power(-2*c4m5*lpulley*lshank - ...
...
s3m4*kknee*kneel*lshank*lthigh*power(-2*c4m5*lpulley*lshank - ...
2*c3m5*lpulley*lthigh + 2*c3m4*lshank*lthigh + lpulley*lpulley + ...
lshank*lshank + lthigh*lthigh,-0.5) + (1 + mfoot)*power(lshank,-1)*power(-1 - ...
mfoot + mfoot*(c3m4*c3m4),-1)*(-(lshank*(q3*khip + hipl*khip + ...
s3m5*kknee*lpulley*lthigh - s3m4*kknee*lshank*lthigh + 2*c3*g*lthigh*mfoot - ...
khip*stanceangle - s3*lthigh*(1 + mfoot)*xpacc + c3*lthigh*(1 + mfoot)*ypacc ...
+ s3m4*lshank*lthigh*mfoot*(u4*u4) - ...
s3m5*kknee*kneel*lpulley*lthigh*power(-2*c4m5*lpulley*lshank - ...
...
lshank*lshank + lthigh*lthigh,-0.5)*(-kneel + power(-2*c4m5*lpulley*lshank - ...
2*c3m5*lpulley*lthigh + 2*c3m4*lshank*lthigh + lpulley*lpulley + ...
lshank*lshank + lthigh*lthigh,0.5)))))*Sec(q3 - q4); 
...
2*c3m5*lpulley*lthigh + 2*c3m4*lshank*lthigh + lpulley*lpulley + ...
lshank*lshank + lthigh*lthigh,-0.5); 
rhs(2) = lshank*(-(g*mfoot*cos(q4 - gslope)) + s3m4*lthigh*mfoot*(u3*u3) - ...
kknee*(s4m5*lpulley + s3m4*lthigh)*power(-2*c4m5*lpulley*lshank - ...
2*c3m5*lpulley*lthigh + 2*c3m4*lshank*lthigh + lpulley*lpulley + ...
lshank*lshank + lthigh*lthigh,-0.5)*(-kneel + power(-2*c4m5*lpulley*lshank - ...
2*c3m5*lpulley*lthigh + 2*c3m4*lshank*lthigh + lpulley*lpulley + ...
