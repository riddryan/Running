...
q4*s3*mfoot*(u3*u3); 
rhs(3) = -(q3*khip) + hipl*khip - q4*mfoot*(2*u3*u4 + g*cos(q3 - gslope)); 
...
kswing*((-q4 + swingl)*(-q4 + swingl)) + 2*q4*g*sin(q3 - gslope) - ...
2*q1*g*sin(gslope))/2.;

PEgrav = q2*g*cos(gslope) + q4*g*sin(q3 - gslope) - q1*g*sin(gslope);

PEspring = (khip*((q3 - hipl)*(q3 - hipl)))/2. + (kswing*((q4 - swingl)*(q4 - ...
swingl)))/2.;
...
rhs(1) = -(q3*khip) + hipl*khip - q4*(2*u3*u4 + g*cos(q3 - gslope)); 
