...
rhs(4) = -(kknee*(-q4 + kneel + pulleyang)) - g*lshank*mfoot*cos(q4 - gslope) ...
...
kknee*((-q4 + kneel + pulleyang)*(-q4 + kneel + pulleyang)) + ...
...
PEspring = (khip*((q3 - hipl)*(q3 - hipl)))/2. + (kknee*((q4 - kneel - ...
pulleyang)*(q4 - kneel - pulleyang)))/2.;
...
accs(1,1) = -((-(c3m4*lthigh*(c4*g*lshank*mfoot + kknee*(-q4 + kneel + ...
pulleyang) - s4*lshank*mfoot*xpacc + c4*lshank*mfoot*ypacc - ...
s3m4*lshank*lthigh*mfoot*(u3*u3))) + lshank*(q3*khip - hipl*khip + ...
2*c3*g*lthigh*mfoot - s3*lthigh*(1 + mfoot)*xpacc + c3*lthigh*(1 + ...
mfoot)*ypacc + ...
s3m4*lshank*lthigh*mfoot*(u4*u4)))*power(lshank,-1)*power(lthigh,-2)*power(1 ...
+ mfoot - mfoot*(c3m4*c3m4),-1)); accs(1,2) = ...
power(lshank,-2)*(-((-(q4*kknee) + kknee*kneel + c4*g*lshank*mfoot + ...
kknee*pulleyang - s4*lshank*mfoot*xpacc + c4*lshank*mfoot*ypacc - ...
s3m4*lshank*lthigh*mfoot*(u3*u3))*power(mfoot,-1)) + ...
c3m4*(-(c3m4*lthigh*(c4*g*lshank*mfoot + kknee*(-q4 + kneel + pulleyang) - ...
s4*lshank*mfoot*xpacc + c4*lshank*mfoot*ypacc - ...
s3m4*lshank*lthigh*mfoot*(u3*u3))) + lshank*(q3*khip - hipl*khip + ...
2*c3*g*lthigh*mfoot - s3*lthigh*(1 + mfoot)*xpacc + c3*lthigh*(1 + ...
mfoot)*ypacc + s3m4*lshank*lthigh*mfoot*(u4*u4)))*power(lthigh,-1)*power(1 + ...
mfoot - mfoot*(c3m4*c3m4),-1)); 
...
rhs(1) = -(q3*khip) + hipl*khip - 2*g*lthigh*mfoot*cos(q3 - gslope) - ...
s3m4*lshank*lthigh*mfoot*(u4*u4); 
rhs(2) = -(kknee*(-q4 + kneel + pulleyang)) - g*lshank*mfoot*cos(q4 - gslope) ...
+ s3m4*lshank*lthigh*mfoot*(u3*u3); 
