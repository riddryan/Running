...
% Mass Matrix
MM(1,1) = -2*q6*q7*msoftparallel - 2*q2*s1*(-(q7*msoftparallel) + q6*(mfoot + ...
msoftparallel)) + (mfoot + msoftparallel + msoftseries)*(q2*q2) + (mfoot + ...
msoftparallel)*(q6*q6) + msoftparallel*(q7*q7); MM(1,2) = ...
c1*(-(q7*msoftparallel) + q6*(mfoot + msoftparallel)); MM(1,3) = 0; MM(1,4) = ...
-(q7*msoftparallel) + q6*(mfoot + msoftparallel) - q2*s1*(mfoot + ...
msoftparallel + msoftseries); MM(1,5) = c1*q2*(mfoot + msoftparallel + ...
msoftseries); MM(1,6) = -(c1*q2*(mfoot + msoftparallel)); MM(1,7) = ...
c1*q2*msoftparallel; 
MM(2,1) = MM(1,2); MM(2,2) = mfoot + msoftparallel + msoftseries; MM(2,3) = ...
0; MM(2,4) = c1*(mfoot + msoftparallel + msoftseries); MM(2,5) = s1*(mfoot + ...
msoftparallel + msoftseries); MM(2,6) = -(s1*(mfoot + msoftparallel)); ...
MM(2,7) = s1*msoftparallel; 
...
MM(5,6) = -mfoot - msoftparallel; MM(5,7) = msoftparallel; 
...
rhs(1) = -(q2*(2*u1*(-(s1*(-(u7*msoftparallel) + u6*(mfoot + msoftparallel))) ...
+ u2*(mfoot + msoftparallel + msoftseries)) + g*(mfoot + msoftparallel + ...
msoftseries)*cos(q1 - gslope))) - q7*msoftparallel*(2*u1*(s1*u2 - u6 + u7) + ...
g*sin(gslope)) + q6*(2*u1*(u7*msoftparallel + s1*u2*(mfoot + msoftparallel) - ...
u6*(mfoot + msoftparallel)) + g*(mfoot + msoftparallel)*sin(gslope)); 
rhs(2) = -(u2*cleg) + kleg*lleg - 2*c1*u1*u6*mfoot - 2*c1*u1*u6*msoftparallel ...
+ 2*c1*u1*u7*msoftparallel + q7*s1*msoftparallel*(u1*u1) - q6*s1*(mfoot + ...
msoftparallel)*(u1*u1) + q2*(-kleg + (mfoot + msoftparallel + ...
msoftseries)*(u1*u1)) - g*mfoot*sin(q1 - gslope) - g*msoftparallel*sin(q1 - ...
gslope) - g*msoftseries*sin(q1 - gslope); 
rhs(3) = -(u3*csoftstomach) - q3*ksoftstomach + ksoftstomach*lsoftstomach - ...
g*msoftstomach*cos(gslope); 
rhs(4) = 2*u1*(u7*msoftparallel - u6*(mfoot + msoftparallel) + s1*u2*(mfoot + ...
msoftparallel + msoftseries)) + c1*q2*(mfoot + msoftparallel + ...
msoftseries)*(u1*u1) + g*(mfoot + mpelvis + msoftparallel + msoftseries + ...
msoftstomach)*sin(gslope); 
rhs(5) = -2*c1*u1*u2*mfoot - 2*c1*u1*u2*msoftparallel - ...
2*c1*u1*u2*msoftseries - g*mfoot*cos(gslope) - g*mpelvis*cos(gslope) - ...
g*msoftparallel*cos(gslope) - g*msoftseries*cos(gslope) - ...
g*msoftstomach*cos(gslope) + q7*msoftparallel*(u1*u1) - q6*(mfoot + ...
msoftparallel)*(u1*u1) + q2*s1*(mfoot + msoftparallel + msoftseries)*(u1*u1); 
rhs(6) = -(u6*csoftseries) + ksoftseries*(-q6 + lsoftseries) + ...
2*c1*u1*u2*(mfoot + msoftparallel) + g*mfoot*cos(gslope) + ...
g*msoftparallel*cos(gslope) + (-(q7*msoftparallel) + q6*(mfoot + ...
msoftparallel) - q2*s1*(mfoot + msoftparallel))*(u1*u1); 
...
kineticEnergy = (mpelvis*(u4*u4 + u5*u5) + msoftseries*(-2*q2*u1*(s1*u4 - ...
c1*u5) + 2*u2*(c1*u4 + s1*u5) + q2*q2*(u1*u1) + u2*u2 + u4*u4 + u5*u5) + ...
msoftstomach*(u4*u4 + (u3 + u5)*(u3 + u5)) + mfoot*(-2*q2*s1*u1*(q6*u1 + u4) ...
+ 2*c1*(q6*u1*u2 + u2*u4 + q2*u1*(u5 - u6)) + 2*s1*u2*(u5 - u6) + ...
q2*q2*(u1*u1) + u2*u2 + (q6*u1 + u4)*(q6*u1 + u4) + (u5 - u6)*(u5 - u6)) + ...
msoftparallel*(-2*q2*s1*u1*(q6*u1 - q7*u1 + u4) + 2*s1*u2*(u5 - u6 + u7) + ...
2*c1*(q6*u1*u2 - q7*u1*u2 + u2*u4 + q2*u1*u5 - q2*u1*u6 + q2*u1*u7) + ...
q2*q2*(u1*u1) + u2*u2 + (q6*u1 - q7*u1 + u4)*(q6*u1 - q7*u1 + u4) + (u5 - u6 ...
+ u7)*(u5 - u6 + u7)))/2.;
...
comvx = (c1*u2*mfoot + u4*mfoot + u4*mpelvis - q7*u1*msoftparallel + ...
c1*u2*msoftparallel + u4*msoftparallel + q6*u1*(mfoot + msoftparallel) + ...
c1*u2*msoftseries + u4*msoftseries - q2*s1*u1*(mfoot + msoftparallel + ...
msoftseries) + u4*msoftstomach)*power(mfoot + mpelvis + msoftparallel + ...
msoftseries + msoftstomach,-1);

comvy = (u5*mfoot - u6*mfoot + u5*mpelvis + u5*msoftparallel - ...
u6*msoftparallel + u7*msoftparallel + u5*msoftseries + c1*q2*u1*(mfoot + ...
msoftparallel + msoftseries) + s1*u2*(mfoot + msoftparallel + msoftseries) + ...
...
velJacobian(8,7) = 0; 
velJacobian(9,1) = q6 - q7 - q2*s1; velJacobian(9,2) = c1; velJacobian(9,3) = ...
0; velJacobian(9,4) = 1; velJacobian(9,5) = 0; velJacobian(9,6) = 0; ...
velJacobian(9,7) = 0; 
velJacobian(10,1) = c1*q2; velJacobian(10,2) = s1; velJacobian(10,3) = 0; ...
velJacobian(10,4) = 0; velJacobian(10,5) = 1; velJacobian(10,6) = -1; ...
velJacobian(10,7) = 1; 
