...
rhs(3) = -(q3*khip) + hipl*khip - 2*g*lthigh*mfoot*cos(q3 - gslope) - ...
s3m4*lshank*lthigh*mfoot*(u4*u4); 
rhs(4) = lshank*mfoot*(-(g*cos(q4 - gslope)) + s3m4*lthigh*(u3*u3)); 
...
accs(1,1) = -(power(lthigh,-2)*power(-3 + cos(2*(q3 - q4)),-1)*(-2*q3*khip + ...
2*hipl*khip - 3*c3*g*lthigh + 3*s3*lthigh*xpacc - 3*c3*lthigh*ypacc + ...
g*lthigh*cos(q3 - 2*q4) + lthigh*ypacc*cos(q3 - 2*q4) - ...
2*s3m4*lshank*lthigh*(u4*u4) + lthigh*xpacc*sin(q3 - 2*q4) - ...
u3*u3*(lthigh*lthigh)*sin(2*(q3 - q4)))); accs(1,2) = ...
power(lshank,-1)*power(lthigh,-1)*power(-2 + c3m4*c3m4,-1)*(-(c3m4*q3*khip) + ...
c3m4*hipl*khip + c4*g*lthigh - s4*lthigh*xpacc + c4*lthigh*ypacc - ...
g*lthigh*cos(2*q3 - q4) - lthigh*ypacc*cos(2*q3 - q4) - ...
2*s3m4*(u3*u3)*(lthigh*lthigh) - (lshank*lthigh*(u4*u4)*sin(2*(q3 - q4)))/2. ...
+ lthigh*xpacc*sin(2*q3 - q4)); 
...
rhs(1) = -(q3*khip) + hipl*khip - 2*g*lthigh*cos(q3 - gslope) - ...
s3m4*lshank*lthigh*(u4*u4); 
rhs(2) = lshank*(-(g*cos(q4 - gslope)) + s3m4*lthigh*(u3*u3)); 
