classdef SoftStomachSeriesRunnerState
    ...
    properties
        ...
        order=[4 5 10 11 1 2 7 8 3 9 6 12];
    end
    
    methods
        
        function [this] = SoftStomachSeriesRunnerState(input)
           if nargin == 0
              return; 
           end
           
           if isnumeric(input)
              this = SoftStomachSeriesRunnerState;
