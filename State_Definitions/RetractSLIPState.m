classdef RetractSLIPState
    ...
    properties
        ...
        swingfoot = struct('Angle', 0,'Length',0,'AngleDot',0,'LengthDot',0);
        
        order=[1 2 7 8 ...
               3 4 9 10 ...
               5 6 11 12]; % The order that these properties read left->right & up-> down appear in the state vector
    end
    
    methods
        
        function [this] = RetractSLIPState(input)
           if nargin == 0
              return; 
           end
           
           if isnumeric(input)
              this = RetractSLIPState;
