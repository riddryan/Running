classdef MasslessAchillesRunnerState
    ...
    properties
        ...
        order=[1 2 7 8 ...
               3 4 ...
               5 ...
               6]; % The order that these properties read left->right & up-> down appear in the state vector
    end
    
    methods
        
        function [this] = MasslessAchillesRunnerState(input)
           if nargin == 0
              return; 
           end
           
           if isnumeric(input)
              this = MasslessAchillesRunnerState;
